    ...
    <div className="state-page">
      ...
      <header className="page-header">
        ...
        <div className="reviewer-badge">
          âœ“ Calculations reviewed by a Certified Public Accountant
        </div>
      </header>
      ...
      <section className="intro-section">
        ...
        <a href="#calculator" className="state-cta">Get Your {stateName} Estimate â†’</a>
      </section>
        ...
        <div className="neighboring-states">
          ...
          <div className="neighboring-grid">
            {neighboringStates.map((neighbor) => (
              ...
              >
                {neighbor.name} Debt Relief Calculator â†’
              </a>
            ))}
          </div>
        </div>
